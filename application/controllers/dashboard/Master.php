...
class Master extends Auth_Controller
{
    ...
    public function index()
    {
        ...
        $this->data['banned_ips'] = $this->banned_model->set_cache('banned_ips',3600)->get_all();
        ...
        if($this->form_validation->run()===FALSE)
        {
            ...
            $this->render('dashboard/master/index_view');
        }
        else
        {
            $update_data = array();
    ...
    public function add_ip()
    {
        ...
        else
        {
            ...
            if($this->banned_model->insert(array('ip'=>$ip,'created_by'=>$this->current_user->id)))
            {
                $this->banned_model->delete_cache('banned_ips')->set_cache('banned_ips',3600)->get_all();
